...
<meta name="theme-color" content="#7952b3">
  ...
  <div class="inscform">
     ...
     <form class="" id="" name="" enctype="multipart/form-data" method="post" action="mot_de_passe_oublier.php">
       <div class="row">
      ...
      <div class="form-group col-12">
           ...
           <br>
            <input type="text" name="username" class="form-control" id="email" placeholder="Nom">
         </div>
      </div>
